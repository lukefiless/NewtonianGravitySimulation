...
public class OrbitDebugDisplay : MonoBehaviour
{
    ...
    void DrawOrbits()
    {
        ...
        {
            var pathColor = bodies[bodyIndex].GetComponentInChildren<MeshRenderer>().sharedMaterial.color;
    ...
    Vector3 CalculateAcceleration(int i, VirtualBody[] virtualBodies)
    {
        ...
        for (int j = 0; j < virtualBodies.Length; j++)
        {
            ...
            acceleration += forceDir * Universe.gravitationalConstant * virtualBodies[j].mass / sqrDist;
        }
        return acceleration;
    }
